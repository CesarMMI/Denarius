...
public class UpdateTransactionQueryTests
{
    [Fact]
    public void Validate_NotThrows_WhenValid()
    {
        // Arrange
        var query = new UpdateTransactionQuery
        {
            Id = 1,
            UserId = 1,
            Amount = 100,
    ...
    [InlineData(-1)]
    [InlineData(0)]
    public void Validate_ThrowsBadRequest_WhenTransactionIdIsInvalid(int transactionId)
    {
        // Arrange
        var query = new UpdateTransactionQuery
        {
